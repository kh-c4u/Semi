...
<body>
	...
	<div class="semi-comu-gisa" style="float: left;">
		<div id="page-title" class="page-title">기능사</div>
		<div class="page-guide">
			<span>해당 게시판은 기능사를 준비하는 수험생 여러분들을 위한 공간입니다. 공부팁, 온라인, 학원 수강 등
		...
		<div class="search-box">
			...
			<div class="search-option">
				<span class="ch-10"> <input type="checkbox" name="searchType"
					searchType="title" checked="checked"> 제목
				</span> <span class="ch-10"> <input type="checkbox"
					name="searchType" searchType="content"> 내용
				</span> <span class="ch-10"> <input type="checkbox"
					name="searchType" searchType="regUserName"> 작성자
				</span>
			</div>
			...
			<div id="btns">
				<a href="javascript:search();" class="btns"><img
					src="./images/seach_gisa.png"></a>
			</div>
		</div>
			...
			<table class="table-gisa" style="word-break: break-all;">
				...
				<tbody id="serach-Result">
					<tr class="notice">
						<td></td>
						<td>공지</td>
						<td class="tleft td-comment"><a href="#">나중에 공지사항 관리자
								수정하게 하기-태민</a></td>
						<td>관리자</td>
						<td>날짜 태민</td>
						<td>조회수 태민</td>
		...
		<div class="paging-wrap">
			...
			<div class="pagination" id="paging-link">
				...
				<%  }else{ %>
				<button
					onclick="location.href='<%= request.getContextPath() %>/selectList.bo?currentPage=<%=currentPage - 1 %>'">이전</button>
				<%  } %>
			...
			%>
				...
				<%  }else{ %>
				<button
					onclick="location.href='<%= request.getContextPath() %>/selectList.bo?currentPage=<%= currentPage + 1 %>'">다음</button>
				<%  } %>
				<button
	...
	<div id="main-footer">
		<div class="main-footer-wrap">
			<div>
				<img src="./images/semiLogosize.png" />
			</div>
			<div>
				<ul>
