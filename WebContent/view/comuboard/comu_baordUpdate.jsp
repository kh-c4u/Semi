...
<body>
    <div id="main-header">
        <div class="main-header-logo"><a href="<%= request.getContextPath()%>/semi_main.jsp">
        <img src="<%=request.getContextPath()%>/resources/images/semiLogosize.png" /></a></div> 
    ...
    <ul id="left-menu-share" class="left-menu1">
        ...
        <div id="write" class ="Nanum2 right_wrapper">
            ...
            <form action="<%=request.getContextPath()%>/comuinsert.bo" method="post" enctype="multipart/form-data">
                ...
                <textarea name="content" cols="40" rows="10"
                             style="width: 800px; height: 300px; resize: none" required="required"
                             <%= b.getBcontent() %>></textarea>
                <br>
                ...
                <div id="btn_group">
                    ...
                    <button type="button" class="btn" id="cancelForm" onclick="cancle()">삭제</button>
		...
		<script>
		function complete(){
			$("#submitForm").attr("action","<%=request.getContextPath() %>/cbUpdate.bo");
