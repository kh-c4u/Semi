...
<body>
	...
	<div class="sub-right-content">
		...
		<div class="left pb5 mr5">
			...
			<a
				href="<%= request.getContextPath()%>/GScbUpView.bo?bno=<%=b.getBno()%>"
				class="btn3">수정</a>
			<% } %>
		</div>
		...
		<div class="comment">
			<div class="replyWriteArea">
				...
				<form action="<%= request.getContextPath()%>/GSCinsertComment.bo"
					method="post">
   ...
   function updateConfirm(obj) {
      ...
      location.href="<%= request.getContextPath()%>/GSupdateComment.bo?"
   ...
   function deleteReply(obj) {
      ...
      location.href="<%= request.getContextPath()%>/GScomentDelete.co"
      +"?cno="+cno+"&bno="+bno;
   }
   ...
   function reConfirm(obj) {
      ...
      location.href='<%= request.getContextPath()%>/GSCinsertComment.bo'
                 + '?writer=<%= m.getUserId() %>' 
