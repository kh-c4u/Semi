	...
	<div class="left-menu">
        ...
        <div id="write" class ="Nanum2 right_wrapper">
            ...
            <form>
                <div class="option-type">
                    ...
                    <div class="select-box">
                        <select id="category-name" name="category-name">
                            ...
                            <option value="합격수기" disabled >합격수기</option>
                            <option value="수강후기" disabled>수강후기</option>
                            <option value="무료인강추천" disabled>무료인강추천</option>
                            <option value="무료인강추천" disabled>무료인강추천</option>
                        </select>
                    </div>
                ...
                <!-- 취소/등록 버튼 -->
                <div id="btn_group">
                    <div class="attachfile" style="display: block;">
                    <input type="file" name="filename" accept=".pdf/image/png,image/jpg,image/bmp,application/vnd.ms-excel ,text/html"/>
                    <input type="file" name="filename2" accept=".pdf/image/png,image/jpg,image/bmp,application/vnd.ms-excel ,text/html"/>
                    </div>
                    <div class="can-sub-buttons">
                    <button class="btn" id="cancel">취소</button>
                    <button class="btn" id="submit">등록</button>
                    </div>
