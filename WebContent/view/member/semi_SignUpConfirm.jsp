...
<link rel="stylesheet"
	href="../../resources/css/semi_Signup_Confirm.css">
	...
	<div id="signUpCompleate">
		<div id="complete">
			...
			<div>
				...
				<br>
				<h3>
					C4U 자격증 회원가입을 환영합니다.<br> 아래 버튼을 누르시면 로그인 페이지로 이동합니다.
				</h3>

				<button type="button" onclick="location.href='semi_Login.jsp'">로그인
					하기</button>
