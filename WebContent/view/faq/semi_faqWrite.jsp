...
<body>
	...
	<div class="left-menu">
        ...
        <div id="write" class ="Nanum2 right_wrapper">
            ...
            <form action="<%=request.getContextPath()%>/fInsert.fa" method="post" enctype="multipart/form-data">
                <div class="option-type">
    
                    <label>제목 :</label>
                    <input type="text" placeholder="제목을 입력하세요." name="ftitle" style="padding:5px 100px 0px 10px;" required="required">
    ...
    <script>
    	function cancel(){
    		location.href="<%=request.getContextPath()%>/flist.fa";
