            ...
            <tbody>
               <tr>
                 ...
                 <tr>
                  ...
                  <td class="pl20 r-noline"><span class="darkgray pr20"><%= b.getBwriterId() %></span></td>
               ...
               <tr>
               	...
               	<td colspan ="6" class="pl20"><%= b.getBcontent() %></td>
      ...
      <div class="comment">
         <div class="replyWriteArea">
            ...
            <table id="replySelectTable"
               ...
               <tr style="border: 1px solid rgb(160, 160, 160); background:rgb(200, 233, 247);">
                  <td>작성자</td>
                  <td colspan="2" style="width: 700px;"><%= bco.getCdate() %></td>

                  <td style="text-align: right;"><input type="hidden"
                     name="cno" value="<%=bco.getCno()%>"/>
              ...
              <tr class="comment replyList<%=bco.getClevel()%>">
                  ...
                  <td colspan="2" style="background: transparent;"><textarea
                        ...
                        required><%= bco.getCcontent() %></textarea>
                  </td>
                  <td></td>
               </tr>
            </table>
