...
<html lang="ko">
 ...
 <!----------------------------------------------------------------------------------------------------->
     ...
     <div class="semi-comu-gisa" style="float: left;">
		<div id="page-title" class="page-title">판매</div>
		...
		<div class="paging-wrap">
			<div class="writeBtn">
				<% if(m != null){ %>
				<button onclick="location.href='view/marketboard/semi_Market_BoardWriting.jsp'"
			...
			<div class="pagination" id="paging-link">
				<button
					onclick="location.href='<%= request.getContextPath() %>/marketselectList.bo?currentPage=1'"><<</button>
				<%  if(currentPage <= 1){  %>
				<button disabled>이전</button>
				<%  }else{ %>
				<button
					onclick="location.href='<%= request.getContextPath() %>/marketselectList.bo?currentPage=<%=currentPage - 1 %>'">이전</button>
				<%  } %>
			...
			%>
				...
				<%      }else{ %>
				<button
					onclick="location.href='<%= request.getContextPath() %>/marketselectList.bo?currentPage=<%= p %>'"><%= p %></button>
				<%      } %>
				<% } %>
				...
				<%  }else{ %>
				<button
					onclick="location.href='<%= request.getContextPath() %>/marketselectList.bo?currentPage=<%=currentPage + 1 %>'">다음</button>
				<%  } %>
				<button
					onclick="location.href='<%= request.getContextPath() %>/marketselectList.bo?currentPage=<%= maxPage %>'">>></button>
