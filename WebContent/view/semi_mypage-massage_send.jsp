...
<body>
	...
	<div class="testbox">
		<div class="tablebox">
			...
			<div>받는사람: 옆집형님</div>
			<textarea id="writeNote" style="resize: none; width: 500px;" rows="6"
				cols="2" title="쪽지 내용을 입력해 주세요."></textarea>

			<div class="btns">
				<a href="#" class="btn replyBtn">답장</a> <a
					href="/semi_mypage_massage list.html" class="btn replyBtn">목록</a>
