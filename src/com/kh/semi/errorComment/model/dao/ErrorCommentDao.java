package com.kh.semi.errorComment.model.dao;
...
public class ErrorCommentDao {
	private Properties prop = new Properties();

	public ErrorCommentDao() {
		String filePath = ErrorCommentDao.class
				.getResource("/config/ErrorComment-query.properties").getPath();
		try {
