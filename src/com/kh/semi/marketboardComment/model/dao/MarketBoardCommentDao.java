package com.kh.semi.marketboardComment.model.dao;
...
public class MarketBoardCommentDao {
	...
	public MarketBoardCommentDao() {
		String filePath = MarketBoardCommentDao.class
				.getResource("/config/Salemarketboardcomment-query.properties").getPath();
		try {
