...
/**
 * Servlet implementation class errorboardListServlet
 */
@WebServlet("/errorList.bo")
public class errorboardListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public errorboardListServlet() {
        super();
