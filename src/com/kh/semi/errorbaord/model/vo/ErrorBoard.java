package com.kh.semi.errorbaord.model.vo;

import java.io.Serializable;
import java.sql.Date;

public class ErrorBoard implements Serializable{

	
	private static final long serialVersionUID = 2181423988086557606L;
	...
	public ErrorBoard(String btitle, String bcontent, String bwriter, String boardfile) {
		super();
		this.btitle = btitle;
	...
	public ErrorBoard(int bno, int btype, String btitle, String bcontent, String bwriter, int bcount, String boardfile,
			Date bdate) {
		super();
		this.bno = bno;
		this.btype = btype;
	...
	//btype리스트용
	public ErrorBoard(int bno, int btype, String btitle, String bwriter, String bwriterId, int bcount, Date bdate,
			String btypestr) {
		super();
		this.bno = bno;
		this.btype = btype;
