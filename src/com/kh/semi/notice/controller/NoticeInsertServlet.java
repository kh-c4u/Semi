...
public class NoticeInsertServlet extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6275690177721531046L;
	...
	int maxSize = 1024*1024*10;
		...
		result = ns.insertNotice(n);
		
		if(result>0) {
			request.getRequestDispatcher("/noticeList.no").forward(request, response);
